...
public class AlterExtCheck extends javax.swing.JDialog {
    private static final long serialVersionUID = 1L;
    private static final Logger LOG = Logger.getLogger(AlterExtCheck.class.getName());
    
    private Check check;
    private Check newCheck;
    private int indexClient;
    private final Connection conn;
    private final QueryExtCheckFrame queryFrame;
    private final CheckController checkControl;
    private final ComboBoxModel<String> boxModel;
    private final int modelIndex;
    
    public AlterExtCheck(java.awt.Frame parent, boolean modal, Check check, Connection conn, ComboBoxModel<String> boxModel, int modelIndex) {
        super(parent, modal);
        this.check = check;
        this.newCheck = null;
        this.conn = conn;
        this.checkControl = new CheckController(conn);
        this.queryFrame = (QueryExtCheckFrame)parent;
