...
import br.com.antoniosergius.chequemate.gui.dialog.AlterExtCheck;
...
import br.com.antoniosergius.chequemate.gui.utils.QueryExtTableModel;
...
public class QueryExtCheckFrame extends javax.swing.JFrame {
    private static final long serialVersionUID = 1L;
    private static final Logger LOG = Logger.getLogger(QueryExtCheckFrame.class.getName());
    
    private QueryExt query;
    private final Connection conn;
    private final CheckController checkControl;
    private QueryExtCheckFrame thisFrame;
    private ArrayList<Check> checkList;
    private ArrayList<String> clientList;
    private QueryExtTableModel model;
    ...
    public QueryExtCheckFrame(Connection conn) {
        this.query = new QueryExt();
        this.conn = conn;
    ...
    public QueryExtCheckFrame(Connection conn, MainFrame mainFrame) {
    ...
    public QueryExt getQuery() {
        return query;
    }

    public void setQuery(QueryExt query) {
        this.query = query;
    }
    ...
    private void initComponents() {
                    ...
                    .addGroup(panelFormLayout.createSequentialGroup()
                        .addGroup(panelFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(javax.swing.GroupLayout.Alignment.LEADING, panelFormLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(labelObs, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                            .addGroup(panelFormLayout.createSequentialGroup()
                                .addGroup(panelFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(panelFormLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(panelFormLayout.createSequentialGroup()
                                ...
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(textFieldBank, javax.swing.GroupLayout.DEFAULT_SIZE, 107, Short.MAX_VALUE))
        ...
        tableCheck.setModel(new QueryExtTableModel());
        ...
        tableCheck.setSurrendersFocusOnKeystroke(true);
    ...
    private void tableCheckMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableCheckMouseClicked
        if (evt.getClickCount() == 2 && tableCheck.getSelectedRowCount() == 1) {
            ...
            new AlterExtCheck(this, true, check, conn, comboBox.getModel(), modelIndex).setVisible(true);
        }
    ...
    private void textFieldObsKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textFieldObsKeyReleased
        query.setObs(textFieldObs.getText());
        queryAndSetupTableData();
        sortByColumn(9);
    }//GEN-LAST:event_textFieldObsKeyReleased
...
// </editor-fold>
    ...
    public void setQueryObject(QueryExt query) {
        this.query = query;
    }
    ...
    public void queryAndSetupTableData() {
        ...
        try {
            list = checkControl.queryExt(query);
        } catch (SQLException ex) {}
        setTableData(list);
        setCursor(new Cursor(Cursor.DEFAULT_CURSOR));
    }
   ...
   private void setupTable() {
        model = (QueryExtTableModel) tableCheck.getModel();
        setupTableSorter();
